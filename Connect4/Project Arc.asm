.data
   ...
   InstructionsTxt db  13,10, "Welcome to our game * Connect 4 * FCI FAYOUM UNIVERSITY  "
                   db  13,10, "The winner must have four squares of your choosen color " 
                   db  13,10,  "Horizontally Vertically or Diagonally .$"
...
; set segment registers:
  ...
  Again:                          ;                           ;-Restarting the game
      ...
      push offset Player1Name     ; Address of plyaer one name  
...
ChooseAgain:
      ...
      push offset Player2Name     ; Address of plyaer two name           
      push offset ColorChooseTxt  ; Text                                          
      call ColorChoose            ; Call to the color choose procedure
...
SameColor: 
 ...
 Next10:       
   ...
   Turn:
      ...
      push  ColsCheck             ; Location of the disc in the array that                        
  ...
  Player1Won:
      ...
      xor  bh, bh                 
      mov  bl, Player1Color       
      push bx                     ; Push Player1 details ,text to stack                   
      push offset Player1Name     
      push offset WinnerTxt                   
  ...
  Player2Won: 
      ...
      xor  bh, bh                                                     
      mov  bl, Player2Color                         
      push bx                     ; Push Player2 details ,text to Stack 
 ...
 enter:                   ;- If enter was enterd
    ...
    ColorList proc
     ...
     mov  cx, 2             ;- Counter of the colors 
     mov  bl, 4             ;- First color code 
     mov  si, 2              ;- Counter of the numbers below the colors                       
                                
     mov  dh, 7              ;- Printing row's position 
     mov  dl, -2             ;- Printing clomn's start position
                                 ;- Printing clomn's start position
...
NextColor:                   
     ...
     inc  si
     inc si  
                             ; Inc the number below the color     
...
PrintAgain:                  
 ...
 NextCheck:
      ...
      mov  si, [bp + 6]       ;                                  SI = colomn loacaion
                              ...
                              ;One vertical possible win options---------------       
                              ; Starting from row number 4 only                  
                              ; SI - represent current disc to check             
                              ; CX - represent other disc of the currnent player  
 ...
 NextCheck1: 
      ...
      mov  di, 5              ; Counter of main diagonal possible win options----
 ...
 NextCheck2: 
     ...
     mov  di, 5              ; Counter of Secondary diagonal possible win options        
